                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                ...
                                <div class="book-ur-car">
                                    <div  class="col-lg-4"><a href="index.php"><button  type="submit" name="contact" id="contact" style="    background-color: #ffd000;color: black;font-size: inherit ;">Outstation</button>
                                            </a></div>
                                                ...
                                                <div class="popular-cars-wrap">
                                                    <div class="popucar-menu text-center">
                                                        ...
                                                        <select class="custom-select">
                                                            ...
                                                            <?php 
                                                $query = "SELECT * FROM `pickup` where `flag`=2";
                                                include 'config.php';
                                                ...
                                                foreach($result as $location){
                                                    ?>
                                                        ...
                                                        <select class="custom-select">
                                                            ...
                                                            <?php 
                                                $query = "SELECT * FROM `droplocation` where `flag`=2";
                                                include 'config.php';
                                                $stmt=$conn->prepare($query);
                                                $stmt->execute();
                                                $result=$stmt->fetchAll();
