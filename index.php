                                ...
                                <div class="book-ur-car">
                                   ...
                                   <div class="row">
                                            ...
                                            <div  class="col-lg-4"><a href="outstation.php"><button  type="submit" name="contact" id="contact" style="    background-color: #ffd000;color: black;font-size: inherit ;">Outstation</button>
                                             ...
                                             <div  class="col-lg-4"><a href="International.php"><button  type="submit"name="contact" id="contact"style="    background-color: #ffd000;color: black;font-size: inherit ;">International</button></a></div>
                                 </div>
                             </div>
                      </div>
                            </div>
