							...
							<div class="profile-header">
								<div class="row align-items-center">
									...
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-0">Paresh More</h4>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														...
														<p class="col-sm-10">Paresh More</p>
													</div>
													<div class="row">
													...
													<div class="row">
														...
														<p class="col-sm-10">paresh@journeyworlddmc.com</p>
													</div>
													<div class="row">
														<p class="col-sm-2 text-muted text-sm-right mb-0 mb-sm-3">Mobile</p>
														<p class="col-sm-10">+9122514719</p>
													</div>
													<div class="row">
														<p class="col-sm-2 text-muted text-sm-right mb-0">Address</p>
														<p class="col-sm-10 mb-0"> A:Shop No. C,  Commercial House,<br>
														Jupiter CHS Near Ganesh Temple,<br>
														Kalyani Nagar,<br>
														Pune,India.</p>
													</div>
												</div>
